...
export function RegisterPage({ onGoogleLogin, themeProps }: RegisterPageProps) {
  ...
  const getInputClass = (hasError: boolean) => `
    h-10 transition-all duration-200 dark:bg-gray-700 dark:text-white
    ${hasError
        ...
        <Card className="border-0 shadow-2xl bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm">
          <CardHeader className="space-y-1 text-center pb-4">
            <motion.div
              ...
              className="mx-auto w-12 h-12 bg-gradient-to-br from-indigo-500 to-purple-500 rounded-2xl flex items-center justify-center mb-2"
            >
          ...
          <CardContent>
            <form onSubmit={handleContinue} className="space-y-3">
              ...
              <Button
                type="submit"
                disabled={isLoading}
                className="w-full h-10 bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white font-semibold rounded-xl transition-all duration-300 transform hover:scale-[1.02] active:scale-[0.98] mt-4"
              >
                {isLoading ? (
            ...
            <div className="mt-3">
              <Button
                ...
                onClick={async () => {
                  setIsLoading(true);
                  await onGoogleLogin();
                  // No set false here, as redirect takes over
                }}
                disabled={isLoading}
            ...
            <p className="text-center text-sm text-gray-500 dark:text-gray-400 mt-4 pt-4 border-t border-gray-200 dark:border-gray-700">
